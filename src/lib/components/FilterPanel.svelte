	...
	<div class="filter-section">
		...
		<div class="filter-row checkbox-row">
			...
			<label
				...
				title="Use player W-L-D records from standings to supplement overall statistics for tournaments without full round data (e.g., Duel Commander and pre-May 2026 MTGO events). Overall win rates are rebalanced for top-32 survivorship bias."
			>
				<input
					type="checkbox"
